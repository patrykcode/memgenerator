        ...
        <div id="app">
            <div class="layer">
                <div class="layers-accordeon">
                    ...
                    <div class="items-accordeon">
                        <button class="btn btn-primary btn-small w-100" v-on:click="addLayer('text-layer')">
            ...
            <div id="canvas">
                <div v-bind:key="'element'+index" v-for="element,index in layers" v-bind:id="'element'+index">
                    <div v-on:mousedown="drag" v-on:click="accordToggle(index)" v-bind:id="'handler'+index+'element'">
                        <component  @click.stop="event.stopPropagation()" :is="element.typ" v-bind:k="index" v-bind:elem="element.data"></component>
                    </div>
                </div>
            </div>
            <canvas id="layerCanvas"  style="display:none;border:1px solid #000000;"></canvas>
        </div>
