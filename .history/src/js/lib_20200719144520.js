...
document.addEventListener('DOMContentLoaded',function(){
    ...
    var app = new Vue({
        ...
        methods:{
            ...
            downloadSVG() {
                const svg = document.getElementById('layerCanvas').innerHTML;
            ...
            render(){
                ...
                var data = '<svg xmlns="http://www.w3.org/2000/svg" width="'+this.canvas.width+'" height="'+this.canvas.height+'">' +
                  '<foreignObject width="100%" height="100%">' +
                  this.html_to_xml(document.getElementById('canvas').outerHTML) +
                  '</foreignObject>' +
                  '</svg>'; 
