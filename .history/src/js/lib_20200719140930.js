        ...
        methods:{
            ...
            render(){
                ...
                var data = '<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200">' +
                  ...
                  '</svg>';
                    console.log(data)
                var DOMURL = 'file:///home/patrykcode/projects/memgenerator/index.html';
                ...
                //         console.log(element)
                //         var top = style.top + parseInt(style['font-size'])
                //         ctx.strokeText(element.data.value, style.left, top);
                //         ctx.fillText(element.data.value, style.left, top);
                //     }
                // }
