    ...
    var app = new Vue({
        ...
        methods:{
            ...
            drag(e){
                ...
                if (document.getElementById('handler'+e.target.id)) {
                    /* if present, the header is where you move the DIV from:*/
                    document.getElementById('handler'+e.target.id).onmousedown = this.dragMouseDown;
                } else {
                    /* otherwise, move the DIV from anywhere inside the DIV:*/
                    e.target.onmousedown = this.dragMouseDown;
                }
