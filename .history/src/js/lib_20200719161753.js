        ...
        methods:{
            addLayer(){
                ...
                for(var i in this.$refs){
                    ...
                    this.dragElement(this.$refs[i][0])
                }
            ...
            dragElement(elmnt) {
                console.log(elmnt,document.getElementById("handler"+elmnt))
                var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0;
                if (document.getElementById("handler"+elmnt  )) {
                  // if present, the header is where you move the DIV from:
                  document.getElementById("handler"+elmnt).onmousedown = dragMouseDown;
                } else {
