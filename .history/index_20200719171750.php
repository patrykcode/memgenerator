        ...
        <div id="app">
            ...
            <div id="canvas">
                <div v-bind:key="'element'+index" v-for="element,index in layers" v-bind:id="'element'+index">
                    <div v-on:mousedown="drag" v-bind:id="'handler'+index+'element'" v-bind:k="index">
                        <component  @click.stop="event.stopPropagation()" :is="element.typ" v-bind:elem="element.data"></component>
                    </div>
                </div>
            </div>
