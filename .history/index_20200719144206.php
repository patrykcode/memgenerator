...
<html>
    ...
    <body>
        <div id="app">
            <div class="layer">
                <ul id="layers">
                    <li><a v-if="downloadUrl" class="btn btn-small btn-success" download="mem.svg" v-bind:href="downloadUrl">pobierz</a></li>
            ...
            <div id="canvas">
                ...
                <div v-bind:key="'element'+index" v-for="element,index in layers">
